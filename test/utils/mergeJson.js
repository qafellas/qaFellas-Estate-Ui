...
for (const pass of combinedJson.passes) {
    pass.file = pass.file.split('/qaFellas-Estate-Ui/qaFellas-Estate-Ui/')[1]
}

for (const fail of combinedJson.failures) {
    fail.file = fail.file.split('/qaFellas-Estate-Ui/qaFellas-Estate-Ui/')[1]
}

for (const p of combinedJson.pending) {
    p.file = p.file.split('/qaFellas-Estate-Ui/qaFellas-Estate-Ui/')[1]
}
